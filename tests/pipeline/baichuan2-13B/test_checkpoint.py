...
class TestCheckpoint(object):
    ...
    def test_baichuan2_hf2mg_tp8pp1(self):
        os.environ["CUDA_DEVICE_MAX_CONNECTIONS"] = "1"
        exit_code = run_cmd(["python3", CKPT_PYPATH] + self.test_config_cmd["test_baichuan2_hf2mg_tp8pp1"])
        assert exit_code == 0
        base_hash = self.test_config['test_baichuan2_hf2mg_tp8pp1'][1]
        save_dir = self.test_config['test_baichuan2_hf2mg_tp8pp1'][0]['save-dir']
